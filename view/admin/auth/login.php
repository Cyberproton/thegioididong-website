<div class="container-md p-3">
    <div class="row">
        ...
        <div class="col col-10 col-md-6 p-5 shadow">
            ...
            <h4 class="text-center mt-3 mb-5"><i class="fas fa-sign-in-alt me-2"></i> Admin Login</h4>
            <form class="needs-validation" method="post" action="/admin/login" novalidate>
