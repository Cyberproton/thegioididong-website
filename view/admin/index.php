    ...
    <div class="row">
        <div class="col col-md-3 col-lg-2 d-none d-md-block p-3 shadow sidebar">
            ...
            <ul class="nav nav-pills flex-column sidebar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="/admin"><i class="fas fa-home me-2"></i> Home</a>
                </li>
                <li class="nav-item">
        ...
        <div class="col col-12 col-md-9 col-lg-10 my-4 text-center my-5">
            <h1 class="text-center">Welcome to Admin Board</h1>
            <p>This website let you manage your contents with a handful of features</p>
            <p class="mb-5">Select a feature on the menu</p>
        </div>
    </div>
</div>